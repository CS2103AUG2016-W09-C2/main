...
//@@author A0135782Y
/**
 * This class served as the occurrence portion in an abstraction occurrence
 * pattern. The abstraction is the Task and the occurrence is the
 * TaskDateComponent.
 *
 */
public class TaskComponent {
     ...
     * 
     * @return True if it has only an end date. False if it also contains a
     *         start date.
     */
    ...
    private boolean isSameStateAs(TaskComponent other) {
        return other == this // short circuit if same object
                || (other != null // this is first to avoid NPE below
                        && other.getTaskReference().getName().equals(this.getTaskReference().getName()) // state
                                                                                                        // checks
                                                                                                        // here
                                                                                                        // onwards
